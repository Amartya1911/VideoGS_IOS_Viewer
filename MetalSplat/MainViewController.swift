...
struct SplatChoiceView: View {
    ...
    @State private var isLivoGSActive = false
...
//                    let totalSpacing = spacing * CGFloat(columns.count - 1)
                    ...
                    let images = [
                        ...
                        (id: 4, name: "cover2", description: "LivoGS"),
                    ]
        ...
        .fullScreenCover(isPresented: $isLivoGSActive) {
            LivoGSSplatView(model: Models.MicLowRes)
        }
    }
